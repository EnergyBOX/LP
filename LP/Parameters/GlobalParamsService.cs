...
{
    /// <summary>
    /// Сервіс для роботи з глобальними параметрами Revit.
    /// Дозволяє отримати або задати значення параметра за ім'ям.
    /// </summary>
    public static class GlobalParamsService
    {
        /// <summary>
        /// Отримати значення глобального параметра (double).
        /// Якщо параметра не існує – повертає 0.0
        /// </summary>
        ...
        /// <summary>
        /// Встановити значення глобального параметра.
        /// Якщо параметра не існує – створює новий.
        /// </summary>
